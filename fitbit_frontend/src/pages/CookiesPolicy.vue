  ...
  <q-card dark bordered class="bg-grey-9 my-card">
        <q-card-section>
            <div class="text-subtitle2">
              ...
              <ul>
                  <li><strong>Organisation</strong> (referred to as either "the Organisation", "We", "Us" or "Our" in this Cookies Policy) refers to Fitbit Monitoring System.</li>
                  <li><strong>You</strong> means the individual accessing or using the Website, or a organisation, or any legal entity on behalf of which such individual is accessing or using the Website, as applicable.</li>
